function [p_f_G, Jnew,RCOND] = calcGNPosEst_R(camStates, observations, noiseParams)
...
C_12 = quatToRotMat(camStates{1}.q2_CG)*quatToRotMat(camStates{secondViewIdx}.q2_CG)';
t_21_1 = quatToRotMat(camStates{1}.q2_CG)*(camStates{secondViewIdx}.p2_C_G - camStates{1}.p2_C_G);
...
for optI = 1:maxIter
    ...
    for iState = 1:Cnum
        ...
        C_i1 = quatToRotMat(camStates{iState}.q2_CG)*(quatToRotMat(camStates{1}.q2_CG)');
        t_1i_i = quatToRotMat(camStates{iState}.q2_CG)*(camStates{1}.p2_C_G - camStates{iState}.p2_C_G);
...
p_f_G = (1/xEst(3))*quatToRotMat(camStates{1}.q2_CG)'*[xEst(1:2); 1] + camStates{1}.p2_C_G; 
